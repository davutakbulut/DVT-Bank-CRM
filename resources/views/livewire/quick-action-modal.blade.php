                    ...
                    @elseif ($activeTab === 'bulk')
                        <div class="space-y-3.5 sm:space-y-4">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                ...
                                <button type="button" wire:click="parseBulk" class="w-full sm:w-auto px-4 py-2 bg-indigo-50 text-indigo-700 hover:bg-indigo-600 hover:text-white font-black text-xs rounded-xl border border-indigo-200 transition-all cursor-pointer text-center">
                                    🔍 Satırları Ayrıştır
                                </button>
                            </div>
                            ...
                            @if (count($bulkParsedList) > 0)
                                <div class="p-3 sm:p-3.5 bg-slate-50 rounded-xl sm:rounded-2xl border border-slate-200/80 space-y-2.5 sm:space-y-3 animate-fade-in">
                                    ...
                                    <div class="pt-2 flex justify-end">
                                        <button type="button" wire:click="saveAllBulk" class="w-full sm:w-auto px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs rounded-xl shadow-md transition-all active:scale-95 cursor-pointer">
                                            ✓ Tümünü Kaydet ({{ count($bulkParsedList) }} Kayıt)
                                        </button>
                                    </div>
                                </div>
                            @endif
