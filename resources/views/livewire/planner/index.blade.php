<div class="py-2 sm:py-6 px-3 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2.5 flex-wrap">
            ...
            <a href="{{ Route::has('planner.print') ? route('planner.print') : url('/app/plan/yazdir') }}" target="_blank" class="inline-flex items-center gap-1.5 px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-800 border border-indigo-300 font-bold text-xs sm:text-sm rounded-lg shadow-2xs transition-all active:scale-95 cursor-pointer">
